...
void main() {
  Swell.init(store: 'malin-malin', key: 'pk_ZAw7FXsVVqG6yinHfaiEx34wFAsk0eDo');
  print(Swell.instance.url.toString());
  print(Swell.instance.key);
  ...
  client.getProducts(null).then((it) => print(it));
}
